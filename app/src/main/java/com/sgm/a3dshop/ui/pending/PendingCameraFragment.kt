...
class PendingCameraFragment : Fragment() {
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    val compressedPath = ImageUtils.compressImage(requireContext(), savedUri, ImageUtils.DIR_PENDING)
    ...
    private fun saveRecord() {
        ...
        setFragmentResult("pending_record_key", bundleOf("pending_record" to pendingProduct))
